...
const ChatScreen = () => {
    ...
    useEffect(() => {
        ...
        // Creiamo l'array di utenti con cui ho chattato
    ...
    const startChat = async (
        ...
        // <-- AGGIUNTO/EDITATO: Se partnerId è vuoto, esci subito
        if (!partnerId) {
            console.error("PartnerId assente, impossibile avviare la chat.");
            return;
        }
        ...
        try {
            ...
            if (existingChat) {
                ...
                // <-- IMPORTANTE: Non impostare id: ''
                const newChat: Omit<ChatMessage, 'id'> = {
                    createdAt: Date.now(),
                    messages: [],
                    partnerAvatar,
                    partnerId,
                ...
                // Assegniamo l'id dopo aver creato il documento
    ...
    useEffect(() => {
        ...
        // <-- AGGIUNTO/EDITATO: Se chat è null o manca l'id, esci
    ...
    const sendMessage = async (e: React.FormEvent) => {
        ...
        // <-- AGGIUNTO/EDITATO: Controllo su chat.id
        if (!chat || !chat.id) {
            console.warn("Tentativo di inviare un messaggio senza una chat valida.");
            return;
        }
